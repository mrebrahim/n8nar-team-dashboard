...
const IMPACT_MESSAGES = {
  'mina@n8nar.com': {
    headline: 'ÃÂÃÂ ÃÂ¨ÃÂÃÂ³ÃÂª ÃÂ¨ÃÂ¬ÃÂÃÂ¯ÃÂ© ÃÂ¹ÃÂ§ÃÂÃÂÃÂ© = 100 ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ© Ã°ÂÂÂ¥',
    sub: 'ÃÂ¨ÃÂÃÂ³ÃÂª ÃÂÃÂÃÂ Ã¢ÂÂ 100K reach Ã¢ÂÂ 1,000 lead Ã¢ÂÂ 100 ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ© = 1,000 EGP ÃÂÃÂ ÃÂ§ÃÂÃÂ¨ÃÂÃÂÃÂµ',
    color: '#4A90D9',
    icon: 'Ã°ÂÂÂ',
  },
  'andrew.i@n8nar.com': {
    headline: 'ÃÂÃÂ ÃÂÃÂ­ÃÂªÃÂÃÂ Reel ÃÂÃÂÃÂ = 2 ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ© Ã°ÂÂÂ¬',
    sub: 'Reel ÃÂÃÂ­ÃÂªÃÂÃÂ Ã¢ÂÂ 10K views Ã¢ÂÂ 100 lead Ã¢ÂÂ 2 ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ© = 20 EGP ÃÂÃÂ ÃÂ§ÃÂÃÂ¨ÃÂÃÂÃÂµ',
    color: '#9B59B6',
    icon: 'Ã°ÂÂÂ¬',
  },
  'andrew.a@n8nar.com': {
    headline: 'ÃÂÃÂ ÃÂÃÂÃÂÃÂªÃÂ§ÃÂ¬ ÃÂÃÂÃÂ = 10 ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ§ÃÂª Ã¢ÂÂÃ¯Â¸Â',
    sub: 'Reel ÃÂÃÂÃÂÃÂªÃÂ§ÃÂ¬ Ã¢ÂÂ 50K views Ã¢ÂÂ 500 lead Ã¢ÂÂ 10 ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ§ÃÂª = 100 EGP ÃÂÃÂ ÃÂ§ÃÂÃÂ¨ÃÂÃÂÃÂµ',
    color: '#E67E22',
    icon: 'Ã¢ÂÂÃ¯Â¸Â',
  },
  'ibram@n8nar.com': {
  ...
  'mariam@n8nar.com': {
    headline: '50 ÃÂÃÂÃÂ§ÃÂÃÂÃÂ© + 100 DM = 3 ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ§ÃÂª ÃÂÃÂÃÂÃÂÃÂ§ÃÂ Ã°ÂÂÂ',
    sub: 'ÃÂªÃÂÃÂ§ÃÂµÃÂ ÃÂÃÂ³ÃÂªÃÂÃÂ± ÃÂÃÂ¹ ÃÂ§ÃÂÃÂ¹ÃÂÃÂÃÂ§ÃÂ¡ Ã¢ÂÂ ÃÂ¯ÃÂ¹ÃÂ ÃÂÃÂÃÂ ÃÂÃÂÃÂ¹ÃÂÃÂÃÂ§ÃÂ¡ Ã¢ÂÂ upsell 2 ÃÂÃÂÃÂ±ÃÂ³ + 10 ÃÂ£ÃÂµÃÂ¯ÃÂÃÂ§ÃÂ¡',
    color: '#27AE60',
    icon: 'Ã°ÂÂÂ',
  },
  'engy@n8nar.com': {
    headline: 'ÃÂ¯ÃÂ¹ÃÂ ÃÂ§ÃÂÃÂ¹ÃÂÃÂÃÂ§ÃÂ¡ ÃÂ§ÃÂÃÂÃÂÃÂªÃÂ§ÃÂ² = ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ§ÃÂª ÃÂÃÂ¶ÃÂ§ÃÂ¹ÃÂÃÂ© Ã°ÂÂÂ¬',
    sub: 'ÃÂ¯ÃÂ¹ÃÂ ÃÂÃÂÃÂ Ã¢ÂÂ ÃÂ§ÃÂÃÂ¹ÃÂÃÂÃÂ ÃÂÃÂ´ÃÂªÃÂ±ÃÂ 2 ÃÂÃÂÃÂ±ÃÂ³ ÃÂ¥ÃÂ¶ÃÂ§ÃÂÃÂ + ÃÂÃÂ¬ÃÂÃÂ¨ 10 ÃÂ£ÃÂµÃÂ¯ÃÂÃÂ§ÃÂ¡',
    color: '#1ABC9C',
    icon: 'Ã°ÂÂÂ¬',
  },
  'bishoy@n8nar.com': {
    headline: 'ÃÂÃÂ Email + ÃÂÃÂÃÂ§ÃÂÃÂ© + WhatsApp = 3 ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ§ÃÂª ÃÂÃÂÃÂÃÂÃÂ§ÃÂ Ã¢ÂÂÃ¯Â¸Â',
    sub: 'Email campaign Ã¢ÂÂ 1 ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ© ÃÂ· WhatsApp negotiation Ã¢ÂÂ 1 ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ© ÃÂ· ÃÂÃÂÃÂ§ÃÂÃÂ© SEO Ã¢ÂÂ 1 ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ©',
    color: '#185FA5',
    icon: 'Ã¢ÂÂÃ¯Â¸Â',
  },
  'ibrahim@n8nar.com': {
    headline: 'ÃÂÃÂ ÃÂÃÂÃÂ¯ÃÂÃÂ YouTube = 2 ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ§ÃÂª Ã°ÂÂÂ¥',
    sub: 'ÃÂÃÂÃÂ¯ÃÂÃÂ YouTube ÃÂªÃÂ¹ÃÂÃÂÃÂÃÂ Ã¢ÂÂ 2 ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ© ÃÂ· FB Ads creative Ã¢ÂÂ 10 ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ§ÃÂª ÃÂ· ÃÂÃÂÃÂ±ÃÂ© ÃÂ¹ÃÂ±ÃÂ¶ ÃÂ¬ÃÂ¯ÃÂÃÂ¯ÃÂ© Ã¢ÂÂ upsell',
    color: '#1B3A6B',
    icon: 'Ã°ÂÂÂ¥',
  },
}
...
const TABS = [
  { id: 'targets', label: 'ÃÂªÃÂ§ÃÂ±ÃÂ¬ÃÂªÃÂ',      icon: 'Ã°ÂÂÂ¯' },
  { id: 'tasks',   label: 'ÃÂÃÂÃÂ§ÃÂÃÂ',        icon: 'Ã¢ÂÂ' },
  { id: 'report',  label: 'ÃÂ±ÃÂÃÂ¹ ÃÂªÃÂÃÂ±ÃÂÃÂ±',    icon: 'Ã°ÂÂÂ' },
  { id: 'mission',   label: 'Mission 1000',  icon: 'Ã°ÂÂÂ¥' },
  { id: 'schedule', label: 'ÃÂ¬ÃÂ¯ÃÂÃÂ ÃÂ§ÃÂÃÂÃÂ­ÃÂªÃÂÃÂ', icon: 'Ã°ÂÂÂ' },
]
...
function TeamTasksSection({ teamTasks, userEmail }) {
  ...
  const title = isContentLead
    ? 'Ã°ÂÂÂ± ÃÂ­ÃÂ§ÃÂÃÂ© ÃÂ§ÃÂÃÂÃÂ´ÃÂ± ÃÂ¹ÃÂÃÂ ÃÂ§ÃÂÃÂ³ÃÂÃÂ´ÃÂÃÂ§ÃÂ Ã¢ÂÂ ÃÂºÃÂÃÂ± ÃÂÃÂÃÂªÃÂÃÂÃÂ©'
    : isMina
    ? 'Ã°ÂÂÂ¥ ÃÂªÃÂ§ÃÂ³ÃÂÃÂ§ÃÂª ÃÂ§ÃÂÃÂÃÂÃÂ¯ÃÂÃÂ§ Ã¢ÂÂ ÃÂºÃÂÃÂ± ÃÂÃÂÃÂªÃÂÃÂÃÂ©'
    : 'Ã°ÂÂÂ¥ ÃÂªÃÂ§ÃÂ³ÃÂÃÂ§ÃÂª ÃÂ§ÃÂÃÂÃÂ±ÃÂÃÂ ÃÂÃÂÃÂ Ã¢ÂÂ ÃÂºÃÂÃÂ± ÃÂÃÂÃÂªÃÂÃÂÃÂ©'

  // Group by employee
  const grouped = {}
  teamTasks.forEach(t => {
    const name = t.emp?.name || 'ÃÂÃÂÃÂ¸ÃÂ'
    if (!grouped[name]) grouped[name] = { color: t.emp?.color || '#666', initials: t.emp?.avatar_initials || '?', tasks: [] }
    grouped[name].tasks.push(t)
  })

  // Get today's completions from supabase Ã¢ÂÂ we just show the tasks as-is
      ...
      {Object.entries(grouped).map(([name, info]) => (
        <div key={name} className="card" style={{ marginBottom: 8, padding: '12px 14px', borderColor: info.color + '30' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
            ...
            <span className="tag badge-err" style={{ fontSize: 9, marginRight: 'auto' }}>{info.tasks.length} ÃÂÃÂÃÂÃÂ©</span>
          </div>
          {info.tasks.map((t, i) => (
            <div key={t.id} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '7px 0', borderBottom: i < info.tasks.length - 1 ? '0.5px solid var(--border)' : 'none' }}>
              ...
              <span className="tag badge-err" style={{ fontSize: 9, flexShrink: 0 }}>ÃÂÃÂ ÃÂªÃÂÃÂªÃÂÃÂ</span>
            </div>
          ))}
        </div>
      ))}
...
export default function EmployeeDashboard({ user, onLogout }) {
  const [tab, setTab] = useState('mission') // Ã¢ÂÂ opens Mission first
  ...
  async function loadAll() {
    ...
    const ROLE_MAP = {
      ...
      'mina@n8nar.com':     'team_leader',   // sees ÃÂ£ÃÂÃÂ¯ÃÂ±ÃÂ ÃÂ¥ÃÂ³ÃÂ­ÃÂ§ÃÂ + ÃÂ£ÃÂÃÂ¯ÃÂ±ÃÂ ÃÂ£ÃÂÃÂÃÂ + ÃÂ¥ÃÂ¨ÃÂ±ÃÂ§ÃÂ
    ...
    const { data: todayRep } = await supabase.from('daily_reports').select('*').eq('employee_id', empId).eq('report_date', today).maybeSingle()
    if (todayRep) {
      setReport(todayRep)
    ...
    if (isEngy) {
      const { data: ts } = await supabase.from('daily_sales').select('*').eq('sale_date', today).maybeSingle()
      setTodaySales(ts)
  ...
  async function toggleTask(taskId) {
    ...
    let repId = report?.id
    if (!repId) {
      const { data: r } = await supabase.from('daily_reports').upsert({ employee_id: employee.id, report_date: today, notes }).select().maybeSingle()
  ...
  async function submitReport() {
    if (!employee) return
    setSaving(true)
    const { data: r } = await supabase.from('daily_reports').upsert({ employee_id: employee.id, report_date: today, notes }, { onConflict: 'employee_id,report_date' }).select().maybeSingle()
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg0)' }}>
      ...
      <div style={{ background: 'var(--bg1)', borderBottom: '0.5px solid var(--border)', padding: '12px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, zIndex: 100 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <button onClick={onLogout} style={{ background: 'transparent', border: '0.5px solid var(--border)', color: 'var(--text3)', borderRadius: 6, padding: '5px 12px', fontSize: 11, cursor: 'pointer' }}>ÃÂ®ÃÂ±ÃÂÃÂ¬</button>
        </div>
      </div>

      {/* Tabs */}
      <div style={{ background: 'var(--bg1)', borderBottom: '0.5px solid var(--border)', padding: '0 16px', display: 'flex', gap: 2, overflowX: 'auto' }}>
        {[...TABS, ...(CAN_ASSIGN_EMAILS.includes(user.email) ? [{ id: 'assign', label: 'ÃÂ¥ÃÂ³ÃÂÃÂ§ÃÂ¯ ÃÂÃÂÃÂ§ÃÂ', icon: 'Ã¢ÂÂ¡' }] : [])].map(t => (
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: tab === 'mission' ? 0 : '20px 16px' }}>
        ...
        {/* Ã¢ÂÂÃ¢ÂÂ SCHEDULE TAB Ã¢ÂÂÃ¢ÂÂ */}
        {tab === 'schedule' && (
        ...
        {/* Ã¢ÂÂÃ¢ÂÂ ASSIGN TAB Ã¢ÂÂÃ¢ÂÂ */}
        {tab === 'assign' && CAN_ASSIGN_EMAILS.includes(user.email) && (
          <div className="fade-in">
            <div style={{ fontSize: 16, fontWeight: 700, marginBottom: 4 }}>ÃÂ¥ÃÂ³ÃÂÃÂ§ÃÂ¯ ÃÂÃÂÃÂÃÂ© ÃÂÃÂÃÂÃÂ±ÃÂÃÂ</div>
            <div style={{ fontSize: 11, color: 'var(--text3)', marginBottom: 16 }}>ÃÂ£ÃÂÃÂª: {user.name}</div>
            ...
            <div className="card" style={{ marginBottom: 14 }}>
              <form onSubmit={submitAssign}>
                <div style={{ display: 'grid', gap: 12 }}>
                  <div>
                    <div style={{ fontSize: 11, color: 'var(--text2)', marginBottom: 5 }}>ÃÂ¹ÃÂÃÂÃÂ§ÃÂ ÃÂ§ÃÂÃÂÃÂÃÂÃÂ© *</div>
                    <input value={aTitle} onChange={e => setATitle(e.target.value)} placeholder="ÃÂÃÂ«ÃÂ§ÃÂ: ÃÂªÃÂµÃÂÃÂÃÂ± Reel ÃÂÃÂÃÂ¨ÃÂÃÂ³ÃÂª ÃÂ§ÃÂÃÂ¬ÃÂ¯ÃÂÃÂ¯" required />
                  </div>
                  <div>
                    <div style={{ fontSize: 11, color: 'var(--text2)', marginBottom: 5 }}>ÃÂ§ÃÂÃÂªÃÂÃÂ§ÃÂµÃÂÃÂ</div>
                    <textarea value={aDesc} onChange={e => setADesc(e.target.value)} rows={2} placeholder="ÃÂªÃÂÃÂ§ÃÂµÃÂÃÂ ÃÂ¥ÃÂ¶ÃÂ§ÃÂÃÂÃÂ©..." style={{ resize: 'vertical' }} />
                  </div>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                    <div>
                      <div style={{ fontSize: 11, color: 'var(--text2)', marginBottom: 5 }}>ÃÂ³ÃÂÃÂ¯ ÃÂÃÂ *</div>
                      <select value={aTo} onChange={e => setATo(e.target.value)} required
                        ...
                        <option value="">ÃÂ§ÃÂ®ÃÂªÃÂ§ÃÂ± ÃÂÃÂÃÂ¸ÃÂ...</option>
                        {allEmployees.map(e => <option key={e.id} value={e.id}>{e.name} Ã¢ÂÂ {e.role}</option>)}
                      </select>
                    </div>
                    <div>
                      <div style={{ fontSize: 11, color: 'var(--text2)', marginBottom: 5 }}>ÃÂ§ÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂ©</div>
                      <select value={aPriority} onChange={e => setAPriority(e.target.value)}
                        style={{ width: '100%', padding: '9px 11px', background: 'var(--bg2)', border: '0.5px solid var(--border)', borderRadius: 8, color: 'var(--text1)', fontSize: 13, fontFamily: 'var(--font)' }}>
                        <option value="low">ÃÂ¹ÃÂ§ÃÂ¯ÃÂ</option>
                        <option value="medium">ÃÂÃÂªÃÂÃÂ³ÃÂ·</option>
                        <option value="high">ÃÂ¹ÃÂ§ÃÂ¬ÃÂ Ã°ÂÂÂ´</option>
                      </select>
                    </div>
                    <div>
                      <div style={{ fontSize: 11, color: 'var(--text2)', marginBottom: 5 }}>ÃÂÃÂÃÂ¹ÃÂ¯ ÃÂ§ÃÂÃÂªÃÂ³ÃÂÃÂÃÂ</div>
                  ...
                  {aSaved && (
                    <div style={{ background: 'rgba(46,204,113,.1)', border: '0.5px solid rgba(46,204,113,.3)', borderRadius: 8, padding: '9px 12px', color: 'var(--green)', fontSize: 12, textAlign: 'center' }}>
                      Ã¢ÂÂ ÃÂªÃÂ ÃÂ¥ÃÂ³ÃÂÃÂ§ÃÂ¯ ÃÂ§ÃÂÃÂÃÂÃÂÃÂ© ÃÂÃÂÃÂÃÂÃÂ¸ÃÂ!
                    </div>
                  )}
                  <button className="primary-btn" type="submit" disabled={aSaving} style={{ background: '#F5A623' }}>
                    {aSaving ? 'ÃÂ¬ÃÂ§ÃÂ±ÃÂ ÃÂ§ÃÂÃÂ¥ÃÂ³ÃÂÃÂ§ÃÂ¯...' : 'Ã¢ÂÂ¡ ÃÂ¥ÃÂ³ÃÂÃÂ§ÃÂ¯ ÃÂ§ÃÂÃÂÃÂÃÂÃÂ©'}
                  </button>
                </div>
              </form>
            </div>
            ...
            <div style={{ fontSize: 11, color: 'var(--text3)', fontWeight: 600, letterSpacing: 1, marginBottom: 10 }}>
              ÃÂ§ÃÂÃÂÃÂÃÂ§ÃÂ ÃÂ§ÃÂÃÂÃÂ ÃÂ£ÃÂ³ÃÂÃÂ¯ÃÂªÃÂÃÂ§ ({myAssignedOut.length})
            </div>
            {myAssignedOut.length === 0 ? (
              <div className="card" style={{ textAlign: 'center', padding: 24, color: 'var(--text3)', fontSize: 13 }}>ÃÂÃÂ ÃÂªÃÂ³ÃÂÃÂ¯ ÃÂ£ÃÂ ÃÂÃÂÃÂ§ÃÂ ÃÂ¨ÃÂ¹ÃÂ¯</div>
            ) : (
                      ...
                      <div style={{ flex: 1 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', marginBottom: 3 }}>
                          ...
                          <span className={`tag ${t.status === 'done' ? 'badge-ok' : t.priority === 'high' ? 'badge-err' : t.priority === 'medium' ? 'badge-warn' : 'badge-neutral'}`} style={{ fontSize: 9 }}>
                            {t.status === 'done' ? 'Ã¢ÂÂ ÃÂÃÂÃÂ¬ÃÂ²ÃÂ©' : t.priority === 'high' ? 'ÃÂ¹ÃÂ§ÃÂ¬ÃÂ' : t.priority === 'medium' ? 'ÃÂÃÂªÃÂÃÂ³ÃÂ·' : 'ÃÂ¹ÃÂ§ÃÂ¯ÃÂ'}
                          </span>
                        </div>
                        {t.description && <div style={{ fontSize: 11, color: 'var(--text3)', marginBottom: 4 }}>{t.description}</div>}
                        <div style={{ fontSize: 10, color: 'var(--text3)' }}>
                          ÃÂÃÂ: <b style={{ color: 'var(--text2)' }}>{t.assigned_to_emp?.name}</b>
                          {t.due_date && <span style={{ color: '#F5A623', marginRight: 8 }}>ÃÂ· ÃÂÃÂÃÂ¹ÃÂ¯: {t.due_date}</span>}
                        </div>
                      </div>
                      {t.status !== 'done' && (
                        <button onClick={() => deleteMyTask(t.id)} style={{ background: 'rgba(231,76,60,.1)', border: 'none', color: 'var(--red)', borderRadius: 6, padding: '4px 8px', fontSize: 11, cursor: 'pointer', flexShrink: 0 }}>ÃÂ­ÃÂ°ÃÂ</button>
                      )}
                    </div>
                  </div>
                ))}
        ...
        {/* Ã¢ÂÂÃ¢ÂÂ MISSION TAB (default) Ã¢ÂÂÃ¢ÂÂ */}
        {tab === 'mission' && (
          <div className="fade-in">
        ...
        {/* Ã¢ÂÂÃ¢ÂÂ TARGETS TAB Ã¢ÂÂÃ¢ÂÂ */}
        {tab === 'targets' && (
          <div className="fade-in">
            ...
            <div className="card" style={{ marginBottom: 14, borderColor: color + '40' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                <div>
                  <div style={{ fontSize: 13, fontWeight: 600 }}>ÃÂ¥ÃÂÃÂ¬ÃÂ§ÃÂ²ÃÂ ÃÂ§ÃÂÃÂÃÂÃÂ</div>
                ...
                <div style={{ textAlign: 'left' }}>
                  ...
                  <div style={{ fontSize: 11, color: 'var(--text3)' }}>{completedCount}/{tasks.length} ÃÂÃÂÃÂÃÂ©</div>
                </div>
              </div>
              ...
              {completionPct >= 100 && <div style={{ marginTop: 10, padding: '8px 12px', background: 'rgba(46,204,113,.1)', border: '0.5px solid rgba(46,204,113,.3)', borderRadius: 8, fontSize: 12, color: 'var(--green)', textAlign: 'center' }}>Ã°ÂÂÂ ÃÂ£ÃÂªÃÂÃÂÃÂª ÃÂÃÂ ÃÂÃÂÃÂ§ÃÂÃÂ ÃÂ§ÃÂÃÂÃÂÃÂ!</div>}
            </div>

            {/* ÃÂ¥ÃÂÃÂ¬ÃÂ sales input */}
            {isEngy && (
              <div className="card" style={{ marginBottom: 14, borderColor: 'rgba(46,204,113,.3)' }}>
                <div style={{ fontSize: 13, fontWeight: 600, marginBottom: 4, color: 'var(--green)' }}>Ã°ÂÂÂ° ÃÂªÃÂ³ÃÂ¬ÃÂÃÂ ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ§ÃÂª ÃÂ§ÃÂÃÂÃÂÃÂ</div>
                <div style={{ fontSize: 11, color: 'var(--text3)', marginBottom: 12 }}>{todaySales ? `Ã¢ÂÂ ÃÂªÃÂ ÃÂ§ÃÂÃÂªÃÂ³ÃÂ¬ÃÂÃÂ Ã¢ÂÂ ${todaySales.sales_count} ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ©` : 'ÃÂÃÂ ÃÂÃÂÃÂ³ÃÂ¬ÃÂÃÂÃÂ ÃÂ¨ÃÂ¹ÃÂ¯'}</div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 10 }}>
                  <div><div style={{ fontSize: 11, color: 'var(--text2)', marginBottom: 5 }}>ÃÂ¹ÃÂ¯ÃÂ¯ ÃÂ§ÃÂÃÂÃÂ¨ÃÂÃÂ¹ÃÂ§ÃÂª</div><input type="number" value={salesInput} onChange={e => setSalesInput(e.target.value)} placeholder="ÃÂÃÂ«ÃÂ§ÃÂ: 11" /></div>
                  <div><div style={{ fontSize: 11, color: 'var(--text2)', marginBottom: 5 }}>ÃÂ§ÃÂÃÂ¥ÃÂÃÂ±ÃÂ§ÃÂ¯ ($)</div><input type="number" value={revenueInput} onChange={e => setRevenueInput(e.target.value)} placeholder="ÃÂÃÂ«ÃÂ§ÃÂ: 660" /></div>
                </div>
                <div style={{ marginBottom: 10 }}><div style={{ fontSize: 11, color: 'var(--text2)', marginBottom: 5 }}>ÃÂÃÂÃÂ§ÃÂ­ÃÂ¸ÃÂ©</div><input type="text" value={salesNote} onChange={e => setSalesNote(e.target.value)} placeholder="ÃÂ£ÃÂ ÃÂÃÂÃÂ§ÃÂ­ÃÂ¸ÃÂ©..." /></div>
                {salesSaved && <div style={{ background: 'rgba(46,204,113,.1)', border: '0.5px solid rgba(46,204,113,.3)', borderRadius: 8, padding: '8px 12px', fontSize: 12, color: 'var(--green)', textAlign: 'center', marginBottom: 8 }}>Ã¢ÂÂ ÃÂªÃÂ ÃÂªÃÂ³ÃÂ¬ÃÂÃÂ ÃÂ§ÃÂÃÂÃÂ¨ÃÂÃÂ¹ÃÂ§ÃÂª ÃÂÃÂªÃÂ­ÃÂ¯ÃÂÃÂ« ÃÂ§ÃÂÃÂªÃÂ§ÃÂ±ÃÂ¬ÃÂª ÃÂ§ÃÂÃÂ£ÃÂ³ÃÂ¨ÃÂÃÂ¹ÃÂ!</div>}
                <button onClick={submitSales} disabled={salesSaving} className="primary-btn" style={{ background: 'var(--green)' }}>{salesSaving ? 'ÃÂ¬ÃÂ§ÃÂ±ÃÂ ÃÂ§ÃÂÃÂ­ÃÂÃÂ¸...' : todaySales ? 'Ã¢ÂÂ» ÃÂªÃÂ­ÃÂ¯ÃÂÃÂ« ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ§ÃÂª ÃÂ§ÃÂÃÂÃÂÃÂ' : '+ ÃÂªÃÂ³ÃÂ¬ÃÂÃÂ ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ§ÃÂª ÃÂ§ÃÂÃÂÃÂÃÂ'}</button>
              </div>
            )}
            ...
            {weeklyTarget && (
              <div style={{ marginBottom: 14 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                  <div style={{ fontSize: 11, color: 'var(--text3)', fontWeight: 600, letterSpacing: 1 }}>ÃÂÃÂ¯ÃÂ ÃÂ§ÃÂÃÂÃÂ±ÃÂÃÂ ÃÂ§ÃÂÃÂÃÂÃÂ Ã¢ÂÂ ÃÂ§ÃÂÃÂ£ÃÂ³ÃÂ¨ÃÂÃÂ¹ {weeklyTarget.week_number}</div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    <span style={{ fontSize: 10, color: 'var(--text3)' }}>{weeklyTarget.week_start} Ã¢ÂÂ {weeklyTarget.week_end}</span>
                    <span className="tag badge-neutral" style={{ fontSize: 9 }}>Ã¢ÂÂ³ ÃÂÃÂªÃÂ­ÃÂ¯ÃÂ« ÃÂªÃÂÃÂÃÂ§ÃÂ¦ÃÂÃÂ§ÃÂ</span>
                  </div>
                </div>
                <div className="grid2">
                  <div style={{ background: 'var(--bg1)', border: '0.5px solid var(--border)', borderRadius: 14, padding: '18px 20px', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <div style={{ fontSize: 11, color: 'var(--text3)', marginBottom: 2, textAlign: 'left' }}>ÃÂ¥ÃÂ¬ÃÂÃÂ§ÃÂÃÂ ÃÂ§ÃÂÃÂÃÂ¨ÃÂÃÂ¹ÃÂ§ÃÂª</div>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 10 }}>
                      <span style={{ color: wSalesPct >= 100 ? 'var(--green)' : wSalesPct >= 70 ? 'var(--amber)' : 'var(--text3)' }}>{wSalesPct}% ÃÂÃÂ ÃÂ§ÃÂÃÂÃÂ¯ÃÂ</span>
                      <span style={{ color: 'var(--text3)' }}>84 ÃÂÃÂ¨ÃÂÃÂ¹ÃÂ©/ÃÂ£ÃÂ³ÃÂ¨ÃÂÃÂ¹</span>
                    </div>
                  </div>
                  <div style={{ background: 'var(--bg1)', border: '0.5px solid var(--border)', borderRadius: 14, padding: '18px 20px', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <div style={{ fontSize: 11, color: 'var(--text3)', marginBottom: 2, textAlign: 'left' }}>ÃÂ¥ÃÂ¬ÃÂÃÂ§ÃÂÃÂ ÃÂ§ÃÂÃÂ Reach</div>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 10 }}>
                      <span style={{ color: wReachPct >= 100 ? 'var(--green)' : wReachPct >= 70 ? 'var(--amber)' : 'var(--text3)' }}>{wReachPct}% ÃÂÃÂ ÃÂ§ÃÂÃÂÃÂ¯ÃÂ</span>
                      <span style={{ color: 'var(--text3)' }}>833,333/ÃÂ£ÃÂ³ÃÂ¨ÃÂÃÂ¹</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {historyReports.length > 0 && (
              <>
                <div style={{ fontSize: 11, color: 'var(--text3)', margin: '14px 0 8px', fontWeight: 600, letterSpacing: 1 }}>ÃÂ¢ÃÂ®ÃÂ± 7 ÃÂ£ÃÂÃÂ§ÃÂ</div>
                <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                  {historyReports.map(r => (
                    <div key={r.id} style={{ background: 'var(--bg2)', border: '0.5px solid var(--border)', borderRadius: 8, padding: '7px 12px', textAlign: 'center', minWidth: 56 }}>
                      ...
                      <div style={{ fontSize: 14, color: 'var(--green)' }}>Ã¢ÂÂ</div>
                    </div>
                  ))}
                </div>
              </>
        ...
        {/* Ã¢ÂÂÃ¢ÂÂ TASKS TAB Ã¢ÂÂÃ¢ÂÂ */}
        {tab === 'tasks' && (
          <div className="fade-in">
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
              <div>
                <div style={{ fontSize: 16, fontWeight: 700 }}>ÃÂÃÂÃÂ§ÃÂÃÂ ÃÂ§ÃÂÃÂÃÂÃÂ</div>
                <div style={{ fontSize: 11, color: 'var(--text3)', marginTop: 2 }}>{completedCount} ÃÂÃÂ {tasks.length} ÃÂÃÂÃÂªÃÂÃÂÃÂ©</div>
              </div>
                  ...
                  <div key={t.id} style={{ display: 'flex', alignItems: 'flex-start', gap: 12, padding: '11px 0', borderBottom: i < tasks.length - 1 ? '0.5px solid var(--border)' : 'none' }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginTop: 4, flexWrap: 'wrap' }}>
                        {t.kpi_target && <span style={{ fontSize: 11, color: 'var(--text3)' }}><span style={{ color }}>ÃÂÃÂ¯ÃÂ:</span> {t.kpi_target} {t.kpi_unit}</span>}
                        {t.deliver_to && (
                          <span style={{ fontSize: 10, background: 'rgba(74,144,217,.1)', border: '0.5px solid rgba(74,144,217,.25)', borderRadius: 5, padding: '2px 8px', color: 'var(--blue)', display: 'inline-flex', alignItems: 'center', gap: 4 }}>
                            <span style={{ opacity: .7 }}>ÃÂÃÂÃÂ³ÃÂÃÂÃÂÃÂ ÃÂ¥ÃÂÃÂ:</span>
                            <span style={{ fontWeight: 700 }}>{t.deliver_to}</span>
                            {t.deliver_by && <span style={{ opacity: .6 }}>ÃÂ· {t.deliver_by}</span>}
                          </span>
                        )}
                      </div>
                    </div>
                    {isDone && <span className="tag badge-ok" style={{ flexShrink: 0, marginTop: 2, fontSize: 10 }}>Ã¢ÂÂ</span>}
                  </div>
                )
              })}
              {tasks.length === 0 && <div style={{ textAlign: 'center', padding: 20, color: 'var(--text3)', fontSize: 13 }}>ÃÂ¬ÃÂ§ÃÂ±ÃÂ ÃÂ§ÃÂÃÂªÃÂ­ÃÂÃÂÃÂ...</div>}
            </div>

            {/* Assigned tasks */}
            {assignedTasks.length > 0 && (
              <>
                <div style={{ fontSize: 11, color: '#F5A623', marginBottom: 8, fontWeight: 600, letterSpacing: 1 }}>Ã¢ÂÂ¡ ÃÂÃÂÃÂ§ÃÂ ÃÂÃÂÃÂ³ÃÂÃÂÃÂ¯ÃÂ© ÃÂ¥ÃÂÃÂÃÂ ({assignedTasks.length})</div>
                    ...
                    <div key={t.id} style={{ display: 'flex', alignItems: 'flex-start', gap: 12, padding: '11px 0', borderBottom: i < assignedTasks.length - 1 ? '0.5px solid var(--border)' : 'none' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{ display: 'flex', gap: 8, marginTop: 5, flexWrap: 'wrap' }}>
                          {t.assigned_by_emp && <span style={{ fontSize: 10, color: 'var(--text3)' }}>ÃÂÃÂ: {t.assigned_by_emp.name}</span>}
                          {t.due_date && <span style={{ fontSize: 10, color: '#F5A623' }}>ÃÂÃÂÃÂ¹ÃÂ¯: {t.due_date}</span>}
                          <span className={`tag ${t.priority === 'high' ? 'badge-err' : t.priority === 'medium' ? 'badge-warn' : 'badge-neutral'}`} style={{ fontSize: 9 }}>{t.priority === 'high' ? 'ÃÂ¹ÃÂ§ÃÂ¬ÃÂ Ã°ÂÂÂ´' : t.priority === 'medium' ? 'ÃÂÃÂªÃÂÃÂ³ÃÂ·' : 'ÃÂ¹ÃÂ§ÃÂ¯ÃÂ'}</span>
                        </div>
                      </div>
                    </div>
                  ))}
        ...
        {/* Ã¢ÂÂÃ¢ÂÂ REPORT TAB Ã¢ÂÂÃ¢ÂÂ */}
        {tab === 'report' && (
          <div className="fade-in">
            <div style={{ marginBottom: 16 }}>
              <div style={{ fontSize: 16, fontWeight: 700 }}>ÃÂ±ÃÂÃÂ¹ ÃÂªÃÂÃÂ±ÃÂÃÂ± ÃÂ§ÃÂÃÂÃÂÃÂ</div>
              <div style={{ fontSize: 11, color: report ? 'var(--green)' : 'var(--text3)', marginTop: 2 }}>{report ? 'Ã¢ÂÂ ÃÂªÃÂ ÃÂ±ÃÂÃÂ¹ ÃÂªÃÂÃÂ±ÃÂÃÂ± ÃÂ§ÃÂÃÂÃÂÃÂ Ã¢ÂÂ ÃÂÃÂÃÂÃÂÃÂ ÃÂ§ÃÂÃÂªÃÂ¹ÃÂ¯ÃÂÃÂ' : 'ÃÂÃÂ ÃÂÃÂÃÂ±ÃÂÃÂ¹ ÃÂ¨ÃÂ¹ÃÂ¯'}</div>
            </div>
            <div className="card" style={{ marginBottom: 14 }}>
              <div style={{ fontSize: 11, color: 'var(--text3)', marginBottom: 12, fontWeight: 600, letterSpacing: 1 }}>ÃÂ§ÃÂÃÂÃÂÃÂ§ÃÂ ÃÂÃÂ§ÃÂÃÂ£ÃÂ±ÃÂÃÂ§ÃÂ ÃÂ§ÃÂÃÂÃÂ¹ÃÂÃÂÃÂ©</div>
              {tasks.map((t, i) => (
                <div key={t.id} style={{ marginBottom: 12, paddingBottom: 12, borderBottom: i < tasks.length - 1 ? '0.5px solid var(--border)' : 'none' }}>
                  ...
                  {t.kpi_target && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, paddingRight: 30 }}>
                      <span style={{ fontSize: 11, color: 'var(--text3)', flexShrink: 0 }}>ÃÂ§ÃÂÃÂÃÂ¹ÃÂÃÂ:</span>
                      <input type="number" value={kpiValues[t.id] || ''} onChange={e => setKpiValues(p => ({ ...p, [t.id]: e.target.value }))} placeholder={`ÃÂÃÂ¯ÃÂ: ${t.kpi_target} ${t.kpi_unit}`} style={{ padding: '6px 10px', fontSize: 12, flex: 1 }} />
            ...
            <div className="card" style={{ marginBottom: 14 }}>
              <div style={{ fontSize: 11, color: 'var(--text3)', marginBottom: 8, fontWeight: 600 }}>ÃÂÃÂÃÂ§ÃÂ­ÃÂ¸ÃÂ§ÃÂª / ÃÂ¹ÃÂÃÂ¨ÃÂ§ÃÂª</div>
              <textarea value={notes} onChange={e => setNotes(e.target.value)} rows={3} placeholder="ÃÂ£ÃÂ ÃÂÃÂÃÂ§ÃÂ­ÃÂ¸ÃÂ© ÃÂÃÂÃÂÃÂ© ÃÂ¹ÃÂ ÃÂ§ÃÂÃÂÃÂÃÂ..." style={{ resize: 'vertical' }} />
            </div>
            {saved && <div style={{ background: 'rgba(46,204,113,.1)', border: '0.5px solid rgba(46,204,113,.3)', borderRadius: 10, padding: '12px 16px', marginBottom: 14, color: 'var(--green)', fontSize: 13, textAlign: 'center' }}>Ã¢ÂÂ ÃÂªÃÂ ÃÂ­ÃÂÃÂ¸ ÃÂ§ÃÂÃÂªÃÂÃÂ±ÃÂÃÂ± ÃÂ¨ÃÂÃÂ¬ÃÂ§ÃÂ­!</div>}
            <button className="primary-btn" onClick={submitReport} disabled={saving} style={{ background: color }}>
              {saving ? <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8, justifyContent: 'center' }}><span style={{ width: 14, height: 14, border: '2px solid rgba(255,255,255,.3)', borderTopColor: '#fff', borderRadius: '50%', animation: 'spin 1s linear infinite', display: 'inline-block' }} />ÃÂ¬ÃÂ§ÃÂ±ÃÂ ÃÂ§ÃÂÃÂ­ÃÂÃÂ¸...</span> : report ? 'ÃÂªÃÂ­ÃÂ¯ÃÂÃÂ« ÃÂ§ÃÂÃÂªÃÂÃÂ±ÃÂÃÂ±' : 'ÃÂ¥ÃÂ±ÃÂ³ÃÂ§ÃÂ ÃÂ§ÃÂÃÂªÃÂÃÂ±ÃÂÃÂ±'}
            </button>
          </div>
        )}
      </div>
